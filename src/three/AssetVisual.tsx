      ...
      {asset.type === 'image' && asset.src && (
        <>
          <mesh position={[0, 0, -0.02]}>
            <planeGeometry args={[sizeW + 0.08, sizeH + 0.08]} />
            <meshBasicMaterial color="#05070b" transparent opacity={0.55 * opacity} toneMapped={false} />
          </mesh>
          <Image
            url={asset.src}
      ...
      {asset.type === 'text' && (
        <>
          <mesh>
            ...
            <meshBasicMaterial color="#171425" transparent opacity={0.66 * opacity} toneMapped={false} />
          </mesh>
          <Text
            fontSize={0.15}
            maxWidth={sizeW - 0.2}
      ...
      {asset.type === 'palette' && (
        <group>
          <mesh position={[0, 0, -0.01]}>
            ...
            <meshBasicMaterial color="#0a0c10" transparent opacity={0.6 * opacity} toneMapped={false} />
          </mesh>
